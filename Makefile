...
BINARY-arm64 ?= $(PROJECT_BASENAME)_$(TARGET_ARCH)_unstripped.spi
...
BINARY_STRIPPED-arm64 = $(PROJECT_BASENAME)_$(TARGET_ARCH).spi
BINARY_STRIPPED-intel32 = $(PROJECT_BASENAME).spi
BINARY_STRIPPED-intel64 = $(PROJECT_BASENAME).sphendif
